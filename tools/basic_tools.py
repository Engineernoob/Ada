    ...
    def _create_summary(self, content: str, context: str | None = None) -> str:
        ...
        for line in lines:
            ...
            if len(line) > 20 and not line.startswith('#'):
                ...
                if any(keyword in line.lower() for keyword in ['important', 'key', 'main', 'result', 'conclusion', 'summary']):
...
class NoteTool:
    ...
    def execute(self, content: str, note_type: str = "general", tags: list[str] | None = None) -> str:
                    ...
                    try:
                        ...
                        if content.startswith('---\n'):
                            ...
                            if len(parts) >= 3:
                                ...
                                notes.append(f"- {metadata['id']}: {metadata.get('type', 'unknown')} {metadata['created']}")
