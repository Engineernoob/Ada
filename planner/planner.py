...
class Plan:
    ...
    def get_next_step(self) -> Optional[PlanStep]:
        ...
        for step in self.steps:
            if not step.completed and all(
                self._get_step_by_id(dep).completed
    ...
    def update_success_rate(self) -> None:
        ...
        completed_steps = sum(
            1 for step in self.steps if step.completed and step.error is None
        )
    ...
    def _create_analyze_plan(self, goal: Goal) -> Plan:
        ...
        steps = [
            ...
            PlanStep(
                ...
                action="interpret",
                parameters={
                    "input": "locate_target.result",
                    "description": f"Analyze {target} content",
                },
            ...
            PlanStep(
                ...
                action="write",
                parameters={
                    "text": "summarize_findings.result",
                    "description": "Save analysis summary to journal",
                },
    ...
    def _create_research_plan(self, goal: Goal) -> Plan:
        ...
        steps = [
            ...
            PlanStep(
                ...
                action="evaluate",
                parameters={
                    "input": "search_topic.result",
                    "description": "Evaluate search sources",
                },
    ...
    def _create_create_plan(self, goal: Goal) -> Plan:
        ...
        steps = [
            PlanStep(
                ...
                parameters={
                    "input": target,
                    "description": f"Analyze requirements for creating {target}",
                },
                dependencies=[],
            ),
            PlanStep(
                ...
                parameters={
                    "path": target,
                    "content": "analyze_requirements.result",
            ...
            PlanStep(
                ...
                action="interpret",
                parameters={
                    "input": "create_content.result",
                    "description": "Review and validate creation",
                },
            ...
            PlanStep(
                ...
                action="write",
                parameters={
                    "text": f"Successfully created {target}",
                    "description": "Log creation completion",
                },
    ...
    def _create_organize_plan(self, goal: Goal) -> Plan:
        ...
        steps = [
            ...
            PlanStep(
                ...
                action="evaluate",
                parameters={
                    "input": "assess_current_state.result",
                    "description": "Design organization structure",
                },
            ...
            PlanStep(
                ...
                parameters={
                    "source": target,
                    "plan": "design_organization.result",
            ...
            PlanStep(
                ...
                parameters={
                    "path": target,
                    "description": "Verify organization results",
                },
    ...
    def _create_learn_plan(self, goal: Goal) -> Plan:
        ...
        steps = [
            PlanStep(
                ...
                parameters={
                    "topic": topic,
                    "description": f"Assess current knowledge of {topic}",
                },
                dependencies=[],
            ),
            PlanStep(
                ...
                parameters={
                    ...
                    "description": f"Find learning resources for {topic}",
                },
            ...
            PlanStep(
                ...
                action="interpret",
                parameters={
                    "input": "find_learning_resources.result",
                    "description": "Study and analyze learning materials",
                },
